...
export const BUCKET_GROUPS: BucketGroup[] = [
  {
    ...
    subtitle:
      'Δεσμευμένο κεφάλαιο, ασθενές μικτό επί τιμής πώλησης ή κίνδυνος έλλειψης — απαιτείται εμπορική απόφαση.',
  ...
  },
  {
    ...
    subtitle: 'Ισχυρή ζήτηση ή ανάγκη αναπλήρωσης — κεφαλαιοποίηση της κίνησης.',
