...
export const BUCKET_DEFS: Record<BucketId, BucketDef> = {
  ...
  new_or_unknown: {
    id: 'new_or_unknown',
    label: 'Νέα ή ανεπαρκή στοιχεία',
    shortLabel: 'Ανεπαρκή στοιχεία',
    description: 'Νέα προϊόντα ή κωδικοί για τους οποίους δεν υπάρχουν ακόμη επαρκή δεδομένα αξιολόγησης.',
    color: 'slate',
    recommendedPolicy: null,
...
export const BUCKET_GROUPS: BucketGroup[] = [
  ...
  },
  {
    ...
    subtitle: 'Κωδικοί χωρίς επαρκή δεδομένα για ασφαλή αξιολόγηση.',
