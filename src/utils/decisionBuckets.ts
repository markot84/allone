...
export const BUCKET_DEFS: Record<BucketId, BucketDef> = {
  dead_capital: {
    id: 'dead_capital',
    label: 'Νεκρά κεφάλαια',
    shortLabel: 'Dead Capital',
    description:
      'Παλιό stock με υψηλή δέσμευση κεφαλαίου και 0 κίνηση τους τελευταίους 3 μήνες.',
    color: 'rose',
  ...
  stockout_risk: {
    ...
    shortLabel: 'Stockout Risk',
    description:
      'Γρήγορη κίνηση και λίγες ημέρες επάρκειας — χάνεις πωλήσεις αν δεν τροφοδοτηθεί.',
    color: 'orange',
  ...
  hot_seller: {
    id: 'hot_seller',
    label: 'Hot sellers',
    shortLabel: 'Hot Seller',
    description: 'Υψηλή κίνηση τις τελευταίες 30 ημέρες με υγιές περιθώριο.',
    color: 'emerald',
  ...
  margin_bleeder: {
    id: 'margin_bleeder',
    label: 'Καίει περιθώριο',
    shortLabel: 'Margin Bleeder',
    description: 'Πουλάει αλλά με αρνητικό ή πολύ χαμηλό περιθώριο — αιμορραγεί κέρδος.',
    color: 'amber',
  ...
  slow_mover: {
    id: 'slow_mover',
    label: 'Αργές κινήσεις',
    shortLabel: 'Slow Mover',
    description: 'Χαμηλή κίνηση 90 ημερών με αξιοπρόσεκτο stock — έγκαιρη ώθηση.',
    color: 'sky',
  ...
  discontinue: {
    id: 'discontinue',
    label: 'Υποψήφια κατάργησης',
    shortLabel: 'Discontinue',
    description:
      'Σημασμένα ως «Προς κατάργηση» ή χωρίς ιστορικό πωλήσεων + παλιό stock.',
    color: 'violet',
    recommendedPolicy: 'stock_clearance',
  ...
  replenish_now: {
    id: 'replenish_now',
    label: 'Άμεση τροφοδοσία',
    shortLabel: 'Replenish Now',
    description: 'Procurement προτείνει ποσότητα ανατροφοδοσίας ή < 7 ημέρες επάρκεια.',
    color: 'indigo',
    recommendedPolicy: null,
    cta: 'Παραγγελία προμηθευτή',
  },
  new_or_unknown: {
    ...
    label: 'Νέα / άγνωστο',
    shortLabel: 'New',
    description: 'Πολύ καινούριο SKU ή δεν υπάρχουν αρκετά σήματα για ταξινόμηση.',
    color: 'slate',
    recommendedPolicy: null,
