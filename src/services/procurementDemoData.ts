...
export async function seedProcurementDemoData(
  ...
  const costingRows: Record<string, string>[] = [
    { 'ΚΩΔΙΚΟΣ': 'SKU-001', 'ΠΕΡΙΓΡΑΦΗ': 'Προϊόν Alpha', 'ΚΑΤΗΓΟΡΙΑ': 'Ηλεκτρονικά', 'ΠΡΩΤΟΓΕΝΕΣ ΚΟΣΤΟΣ': '12,50', 'ΔΕΥΤΕΡΟΓΕΝΕΣ ΚΟΣΤΟΣ': '2,30', 'ΑΝΑΛΥΣΗ ΚΟΣΤΟΥΣ ΑΝΑ ΔΡΑΣΤΗΡΙΟΤΗΤΑ': 'Συσκευασία 1,20€ · Μεταφορά 0,80€ · Αποθήκη 0,30€', 'ΜΕΣΟ ΚΟΣΤΟΣ ΚΑΤΗΓΟΡΙΑΣ': '11,20' },
    { 'ΚΩΔΙΚΟΣ': 'SKU-002', 'ΠΕΡΙΓΡΑΦΗ': 'Προϊόν Beta', 'ΚΑΤΗΓΟΡΙΑ': 'Ρούχα', 'ΠΡΩΤΟΓΕΝΕΣ ΚΟΣΤΟΣ': '8,20', 'ΔΕΥΤΕΡΟΓΕΝΕΣ ΚΟΣΤΟΣ': '1,50', 'ΑΝΑΛΥΣΗ ΚΟΣΤΟΥΣ ΑΝΑ ΔΡΑΣΤΗΡΙΟΤΗΤΑ': 'Συσκευασία 0,60€ · Μεταφορά 0,50€', 'ΜΕΣΟ ΚΟΣΤΟΣ ΚΑΤΗΓΟΡΙΑΣ': '9,10' },
    { 'ΚΩΔΙΚΟΣ': 'SKU-003', 'ΠΕΡΙΓΡΑΦΗ': 'Προϊόν Gamma', 'ΚΑΤΗΓΟΡΙΑ': 'Αξεσουάρ', 'ΠΡΩΤΟΓΕΝΕΣ ΚΟΣΤΟΣ': '3,40', 'ΔΕΥΤΕΡΟΓΕΝΕΣ ΚΟΣΤΟΣ': '0,80', 'ΑΝΑΛΥΣΗ ΚΟΣΤΟΥΣ ΑΝΑ ΔΡΑΣΤΗΡΙΟΤΗΤΑ': 'Συσκευασία 0,40€', 'ΜΕΣΟ ΚΟΣΤΟΣ ΚΑΤΗΓΟΡΙΑΣ': '3,90' },
  ];
