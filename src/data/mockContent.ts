...
export const strategyContentMap = {
  profit_max: {
    ...
    content_tone: 'Αναβαθμισμένος, ποιοτικός, με έμφαση στην αξία',
    content_types: ['Ιστορίες brand', 'Οδηγοί ειδικών', 'Συγκρίσεις ποιότητας'],
    channels: ['Email nurture', 'Blog/SEO', 'LinkedIn'],
    cta_style: 'Ήπια προτροπή, με έμφαση στη σχέση και την αξία',
    avoid: ['Έντονη εκπτωτική γλώσσα', 'Πίεση επείγοντος', 'Μαζικό και γενικόλογο μήνυμα'],
    sample_headlines: [
  ...
  stock_clearance: {
    ...
    content_tone: 'Άμεσος, σαφής, με έμφαση στη διάθεση αποθέματος',
    content_types: ['Flash sales', 'Ειδοποιήσεις τελευταίας ευκαιρίας', 'Συνδυαστικές προσφορές'],
    channels: ['Email blasts', 'SMS', 'Paid social', 'Remarketing'],
    cta_style: 'Σαφής εμπορική προτροπή με χρονικό περιορισμό',
    avoid: ['Εκτενές αφηγηματικό περιεχόμενο', 'Αφηγήσεις brand', 'Εκπαιδευτικό ύφος'],
    sample_headlines: [
  ...
  brand_launch: {
    ...
    icon: '🚀',
    name: 'Brand Launch',
    content_tone: 'Εισαγωγικός, επιμελημένος, με έμφαση στη νεότητα και τη διαφοροποίηση',
    content_types: ['Προαναγγελίες λανσαρίσματος', 'Unboxing περιεχόμενο', 'Πρόσβαση πριν από το κοινό άνοιγμα'],
    channels: ['Organic social', 'Email teasers', 'Influencer'],
    cta_style: 'Προνόμια πρώιμης πρόσβασης και αποκλειστικής γνωριμίας',
    avoid: ['Υπερβολική έμφαση στην τιμή', 'Συγκριτικό περιεχόμενο', 'Γενικόλογο μήνυμα'],
    sample_headlines: [
  ...
  revenue_push: {
    ...
    icon: '📈',
    name: 'Revenue Push',
    content_tone: 'Πρακτικός, προσανατολισμένος στην αξία και στην κοινωνική απόδειξη',
    content_types: ['Best sellers', 'Σύνοψη αξιολογήσεων', 'Οδηγοί χρήσης'],
    channels: ['Google Shopping', 'Meta Ads', 'Email promos'],
    cta_style: 'Καθαρή πρόταση αξίας και ευθεία διαδρομή προς τη μετατροπή',
    avoid: ['Αποκλειστικά premium positioning', 'Αργό χτίσιμο ενδιαφέροντος', 'Υπερβολικά στενή στόχευση'],
    sample_headlines: [
  ...
  sales_base: {
    ...
    content_tone: 'Διαγνωστικός, προσανατολισμένος σε πρόβλημα-λύση, με βάση τα δεδομένα',
    content_types: ['Δημιουργικά ανά bucket', 'Emails επανενεργοποίησης', 'Ακολουθίες ανάκτησης ενδιαφέροντος'],
    channels: ['Email triggers', 'Remarketing', 'Στοχευμένο social', 'Άμεση επικοινωνία'],
    cta_style: 'Σαφής προτροπή ανά διάγνωση, όπως εκκαθάριση, επανενεργοποίηση ή ειδοποίηση αναπλήρωσης',
    avoid: ['Γενικές προωθήσεις καταλόγου', 'Ενιαίο μήνυμα για όλα τα κοινά'],
    sample_headlines: [
  ...
  price_benchmark: {
    ...
    content_tone: 'Σίγουρος, συγκριτικός, με καθαρή τεκμηρίωση αξίας',
    content_types: ['Αναφορές αντιστοίχισης τιμής', 'Λίστες συμφέρουσας τιμής', 'Συγκριτικοί οδηγοί'],
    channels: ['Google Shopping', 'Comparison meta', 'PMax', 'SEO landing pages'],
    cta_style: 'Τεκμηρίωση τιμολογιακού πλεονεκτήματος με σαφές value claim',
    avoid: ['Μαλακή αφηγηματική προσέγγιση brand', 'Αποκλειστικά premium positioning'],
    sample_headlines: [
  ...
  mixed: {
    ...
    content_tone: 'Προσαρμοστικός, με συνδυασμό των επιμέρους κατευθύνσεων',
    content_types: ['Υβριδικά βασικά δημιουργικά', 'Καμπάνιες με διαβαθμίσεις', 'Αφηγήσεις για πολλαπλά segments'],
    channels: ['Συνδυασμός καναλιών των επιμέρους στρατηγικών', 'Email segmentation', 'Multi-format social'],
    cta_style: 'Διαφοροποιημένο ανά segment και επιμέρους στρατηγικό σκέλος',
    avoid: ['Ασαφές μήνυμα', 'Συγκρουόμενες προσφορές στο ίδιο σημείο επαφής'],
    sample_headlines: [
  ...
  seasonal_discount: {
    ...
    content_tone: 'Εποχικός, άμεσος, συνδεδεμένος με την περίσταση',
    content_types: ['Emails αντίστροφης μέτρησης', 'Οδηγοί δώρων', 'Θεματικές landing pages', 'Σειρές stories'],
    channels: ['Email blasts', 'SMS', 'Paid social', 'Display remarketing', 'Affiliate'],
    cta_style: 'Χρονικά περιορισμένη προτροπή, με σαφές εποχικό όφελος',
    avoid: ['Διαχρονικό περιεχόμενο', 'Μακρά nurture flows'],
    sample_headlines: [
