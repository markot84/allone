...
- ΣΩΣΤΟ: «Ως ένας από τους πιο αγαπημένους μας πελάτες…», «Σας έχουμε χάσει, επιστρέψτε με 20% έκπτωση», «Καλωσήρθατε στην οικογένειά μας», «Ανακαλύψτε τις νέες αφίξεις».
...
- Όταν θέλεις να επικοινωνήσεις προσφορά λόγω stock/margin θέματος, χρησιμοποίησε καταναλωτική γλώσσα:
  ...
  • win-back → «μας λείψατε», «επιστρέψτε με δώρο»
...
- ΛΑΘΟΣ: «Αγαπητοί At Risk πελάτες, σας έχουμε χάσει! Επιστρέψτε…»
  → ΣΩΣΤΟ: «Σας έχουμε χάσει! Επιστρέψτε με 20% έκπτωση στην επόμενη παραγγελία σας.»
