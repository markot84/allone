    ...
    <div className="min-h-0 flex flex-col">
      <div className="max-w-6xl mx-auto w-full flex-1 flex flex-col gap-8 pb-10">
        <PageHeader
          ...
          title="AI Insights"
          description={
            <p className="text-sm text-[var(--text-secondary)] sm:text-base max-w-2xl">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
            ...
            <div className="space-y-4">
              {filteredInsights.length === 0 ? (
                <div className="rounded-xl border border-dashed border-[#D1D5DB] bg-[#FAFAFA] px-8 py-16 text-center">
                  ...
                  <p className="text-[var(--text-secondary)] font-medium">Δεν υπάρχουν insights σε αυτό το φίλτρο</p>
          ...
          <aside className="xl:col-span-4 space-y-4 xl:sticky xl:top-4">
            ...
            <div className="rounded-2xl border border-[#E8E8ED] bg-[#F9FAFB] p-5 text-sm text-[var(--text-secondary)]">
