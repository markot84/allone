                  ...
                  <div className="flex-1 min-w-0 space-y-2">
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        <p
                          className={`text-[var(--text-secondary)] mt-1 leading-relaxed ${
                            ...
                            <button
                              ...
                              className={`leading-none rounded-lg border font-medium transition-all flex items-center gap-1 ${
                                ...
                                isActive
                                  ...
                                  : 'border-[var(--border)] bg-white text-[var(--text-secondary)] hover:border-[var(--nts-accent)]/45 hover:bg-orange-50/50 hover:text-[var(--orange-700)]'
                              } disabled:opacity-60`}
                            >
                              {saving && isActive ? (
