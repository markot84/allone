  ...
  return (
    ...
    <Card>
      <div className="p-6">
        ...
        {showForm && (
          <form onSubmit={handleSubmit} className="mb-4 p-4 bg-[var(--surface-1)] rounded-lg border border-[var(--border)]">
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg hover:bg-red-50 text-[var(--text-muted)] hover:text-red-600"
                    title="Διαγραφή"
                    disabled={isDeleting}
                  >
                    <Trash2 size={16} />
