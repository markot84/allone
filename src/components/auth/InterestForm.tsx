...
export function InterestForm() {
  ...
  const inputClass =
    'w-full rounded-xl border border-[var(--border)] bg-[var(--nts-bg-pure)] px-4 py-2.5 text-sm text-[var(--nts-charcoal)] placeholder:text-[var(--nts-medium-gray)] focus:border-[var(--nts-accent)] focus:outline-none focus:ring-1 focus:ring-[var(--nts-accent)]/30';

  return (
    <Card padding="none" className="overflow-hidden border-[var(--border)] shadow-[0_24px_60px_rgba(16,24,40,0.12)]">
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      selected
                        ? 'border-[var(--nts-accent)] btn-gold text-white shadow-[0_8px_18px_rgba(249,115,22,0.22)]'
                        : 'border-[var(--border)] bg-[var(--nts-bg-subtle)] text-[var(--nts-charcoal)] hover:border-[var(--nts-accent)]/40',
                    ].join(' ')}
                  >
                    {option}
                  </button>
