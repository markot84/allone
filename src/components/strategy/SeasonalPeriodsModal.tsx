                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium btn-gold text-white hover:opacity-90 transition-opacity"
                      >
                        <Zap size={11} />
                        Εφαρμογή
                      </button>
                      {period.isCustom && (
                        <button
                          ...
                          className="p-1.5 rounded-lg text-[var(--text-muted)] hover:text-[var(--danger-600)] hover:bg-[var(--danger-light)] transition-colors"
                        >
                          <Trash2 size={13} />
                        </button>
                      )}
