    ...
    <div className="rounded-xl border border-[var(--border)] bg-white overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-8 h-8 rounded-lg bg-[var(--navy-500)] flex items-center justify-center flex-shrink-0">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-[var(--navy-500)] text-white hover:bg-[var(--navy-900)] transition-colors disabled:opacity-50"
          ...
          >
            <div className="px-4 pb-4 border-t border-[var(--surface-2)]">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-3">
                ...
                <div className="p-3 rounded-lg bg-[var(--surface-2)]">
                  <div className="flex items-center gap-1.5 mb-1.5">
                    <Users size={12} className="text-[var(--seg-potential)]" />
                    <span className="text-[10px] font-semibold text-[var(--text-muted)] uppercase tracking-wider">Segments</span>
                  </div>
                  {idealSegs.length > 0 && (
                ...
                <div className="p-3 rounded-lg bg-[var(--surface-2)]">
                  <div className="flex items-center gap-1.5 mb-1.5">
                    <BarChart3 size={12} className="text-[var(--success-700)]" />
