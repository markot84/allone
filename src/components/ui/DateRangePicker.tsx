            ...
            <div key={ds} className="relative h-8 flex items-center justify-center">
              ...
              <button
                ...
                className={`
                  ...
                  ${isFuture ? 'text-[var(--border-strong)] cursor-not-allowed' : 'cursor-pointer'}
                  ${isStart || isEnd
                    ? 'bg-[var(--nts-accent)] text-white font-semibold shadow-sm'
                    : isFuture
                    ? ''
                    : 'text-[var(--text-secondary)] hover:bg-[var(--nts-accent)] hover:text-white hover:opacity-80'}
      ...
      {open &&
        ...
        createPortal(
          ...
          <div className="flex min-w-0 flex-1 flex-col overflow-y-auto">
            ...
            {/* Footer */}
            <div className="flex items-center justify-between px-4 py-3 border-t border-[var(--surface-2)] bg-[var(--surface-1)]">
              <div className="flex items-center gap-2 text-sm">
                <span className={`px-3 py-1.5 rounded-md border text-sm ${
                  pendingFrom
                    ...
                    : 'border-dashed border-[var(--border-strong)] text-[var(--text-muted)]'
                }`}>
                  {pendingFrom ? formatDisplay(pendingFrom) : 'Ημ. έναρξης'}
                </span>
                <span className="text-[var(--border-strong)] font-light text-base">→</span>
                <span className={`px-3 py-1.5 rounded-md border text-sm ${
                  pendingTo
                    ? 'border-[var(--nts-accent)]/50 bg-white text-[var(--text-primary)] font-medium'
                    : 'border-dashed border-[var(--border-strong)] text-[var(--text-muted)]'
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-1.5 text-sm rounded-lg border border-[var(--border)] text-[var(--text-secondary)] hover:bg-[var(--surface-1)] transition-colors"
                >
                  Ακύρωση
                </button>
                <button
